...
// Importar updateServiceSchema
import { serviceSchema, updateServiceSchema } from '../schemas/zod/serviceSchema';
 ...
 */
// CORRIGIDO: Usando updateServiceSchema para permitir campos opcionais (como o nome)
