...
// Importa o novo esquema
import { createDogSchema, updateDogSchema } from '../schemas/zod/dogSchema'; 
 ...
 */
// CORRIGIDO: Usando o esquema que permite campos opcionais.
router.put('/:id', validateSchema(updateDogSchema), updateDog); 
